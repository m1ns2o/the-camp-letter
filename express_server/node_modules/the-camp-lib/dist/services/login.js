...
function login(id, password) {
    return __awaiter(this, void 0, void 0, function () {
        var options, result, response, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = {
                        url: utils_1.buildRequestUrl('login/loginA.do'),
                        method: 'POST',
                        headers: {
                ...
                case 1:
                    response = _a.sent();
                    utils_1.addLog('login', response.statusCode + " " + response.statusMessage);
                    body = response.body;
                    if (!body) {
                    ...
                    result = utils_1.extractCookies(response.headers['set-cookie']);
                    if (!result) {
                        throw new Error('응답 값이 없습니다.');
                    }
