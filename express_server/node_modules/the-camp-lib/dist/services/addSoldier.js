 ...
 */
function addSoldier(cookies, soldier) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = {
                        url: utils_1.buildRequestUrl('missSoldier/insertDirectMissSoldierA.do'),
                        method: 'POST',
                        headers: {
                ...
                case 1:
                    response = _a.sent();
                    utils_1.addLog('addSoldier', response.statusCode + " " + response.statusMessage);
                    body = response.body;
                    if (!body) {
