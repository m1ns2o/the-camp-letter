 ...
 */
function sendMessage(cookies, trainee, message) {
    return __awaiter(this, void 0, void 0, function () {
        var options, response, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (trainee.getMissSoldierClassCd() !== models_1.SoldierClass['예비군인/훈련병']) {
                        throw new Error('예비군인/훈련병에게만 편지를 보낼 수 있습니다.');
                    }
                    options = {
                        uri: utils_1.buildRequestUrl('consolLetter/insertConsolLetterA.do?'),
                        method: 'POST',
                        headers: {
                ...
                case 1:
                    response = _a.sent();
                    utils_1.addLog('sendMessage', response.statusCode + " " + response.statusMessage);
                    body = response.body;
                    if (!body) {
